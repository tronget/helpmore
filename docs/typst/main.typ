...
- U1.2 Интуитивный интерфейс и удобная навигация; нахождение нужного контента менее чем за 45 секунд.
- U1.3 Доступность: ARIA-атрибуты.
- U1.4 Мультиязычность интерфейса; выбор языка через настройки аккаунта.

=== R2: Надежность

- R2.1 Доступность не менее 95%.
...
- P3.3 Пропускная способность: ~10000 просмотров услуг и ~1000 публикаций в день.
...
- S4.9 Интернационализация интерфейса (i18n, напр. Globalize.js) для поддержки трёх языков: русский, английский, китайский.
