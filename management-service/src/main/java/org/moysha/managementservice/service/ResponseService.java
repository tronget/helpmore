...
public class ResponseService {
    ...
    public ResponseDto respond(Long serviceId, CreateResponseRequest request) {
        ...
        if (responseRepository.existsBySender_IdAndService_Id(request.getSenderId(), serviceId)) {
    ...
    private ResponseDto toDto(ResponseEntity entity) {
        return new ResponseDto(entity.getId(), entity.getService().getId(), entity.getSender().getId(), entity.getComment(), entity.getCreatedAt());
    }
}
